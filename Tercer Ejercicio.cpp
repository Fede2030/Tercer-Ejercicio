...
int main() {
    ...
    if (index != -1) {
        std::cout << "El valor " << search_value << " se encuentra en la posicion " << index << " del arreglo." << std::endl;
    }
    else {
        std::cout << "El valor " << search_value << " no se encuentra en el arreglo -1." << std::endl;
    }
